...
def main():
    ...
    pose.position.x = 0.1#0.05
    pose.position.y = 0#.045
    pose.position.z = 0
    pose.orientation.w = 1

    rootstock_arm_move_group.moveToPoseCartesianPathCommander(pose, max_velocity_scaling_factor=1)
    ...
    rootstock_arm_move_group.moveToJointPoseCommander(joint_names, joint_positions, max_velocity_scaling_factor=1)
