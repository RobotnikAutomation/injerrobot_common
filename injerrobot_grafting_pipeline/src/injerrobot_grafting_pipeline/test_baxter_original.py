...
def create_path_contraints():
    ...
    orientation_constraint.orientation.x = 0.689
    orientation_constraint.orientation.y = 0.116
    orientation_constraint.orientation.z = 0.715
    orientation_constraint.orientation.w = -0.006
